...
const spiralOrder = (matrix) => {
    ...
    // Just in case we re-add any extra on final iterations (ie re-adding values at the end) with the above algorithm.
    // This can occur when the matrix isn't a square, or when the final iteration is one flat row.
    // Hey, it works lol.
