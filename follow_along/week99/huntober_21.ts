...
//         assert.equal(ransomableByWords("sit ad est sint", magazine), true)
//     })
//
//     it("Should return false", () => {
//         assert.equal(ransomableByWords("sit ad est love", magazine), false);
//     });
//
//     it("Should return true", () => {
//         assert.equal(ransomableByWords("sit ad est sint in in", magazine), true);
//     });
//
//     it("Should return false", () => {
//         assert.equal(ransomableByWords("sit ad est sint in in in in", magazine), false);
//     });
// });